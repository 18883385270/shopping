<template>
    <div class="page">
        <mi-header title="填写退货信息"></mi-header>
        <div class="tablerow">
        ...
        <div class="btnwp">
            <button class="button success" @click="DeliverEvent">确认提交</button>
        </div>
...
export default {
    ...
    mounted() {
        if(!checkJs.isNullOrEmpty(sessionStorage.UserStoreOrder)){
    ...
    methods: {
        ...
        DeliverEvent(){
            ...
            console.log(params);
            api.ReturnDeliverApi(params).then(
                res => {
                    if (res.data.Code == 200) {
                      this.goSuccessPage('orders','操作成功')
                    } else {
