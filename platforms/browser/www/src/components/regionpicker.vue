    ...
    <transition name="animateBase">
        <div class="shade" v-show="isModalShow">
            ...
            <div class="regionsection">
                <p>已选地区</p>
                <div class="regioncnt"> {{selectedval.join(' ')}}</div>
            </div>
            <div class="regionsection">
                <p>全部地址</p>
                <ul>
...
export default {
    ...
    mounted() {
        this.selectedlist.push(this.regiondata);
    ...
    methods: {
        ...
        changelist(index) {
            if (this.selectedval.length < this.selectlevel){
                var newlist = this.currentlist[index].subdata;
                var name=this.currentlist[index].name;
                this.selectedlist.push(newlist);
                this.selectedval.push(name);
                this.currentlist=newlist;
            }
            else{
                var name=this.currentlist[index].name
                this.selectedval.push(name);
                this.$emit('regionPickerEvent', this.selectedval.join(' '));
                this.close();
            }
        },
        backlist() {
            ...
            this.currentlist=this.selectedlist[this.selectedlist.length-1];
        }
    }
}
</script>
